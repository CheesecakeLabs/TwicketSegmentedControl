...
public protocol TwicketSegmentedControlDelegate: class {
    func didSelect(_ twicketSegmentedControl: TwicketSegmentedControl, didSelect index: Int, previousIndex: Int)
    func didClick(_ twicketSegmentedControl: TwicketSegmentedControl, didClick index: Int, previousIndex: Int)
}
...
open class TwicketSegmentedControl: UIControl {
    ...
    @objc private func didTap(tapGesture: UITapGestureRecognizer) {
        let (previousIndex, index) = moveToNearestPoint(basedOn: tapGesture)
        delegate?.didClick(self, didClick: index, previousIndex: previousIndex)
    }
    ...
    private func moveToNearestPoint(basedOn gesture: UIGestureRecognizer, velocity: CGPoint? = nil) -> (Int, Int) {
        ...
        move(to: index)
        delegate?.didSelect(self, didSelect: index, previousIndex: previousIndex)
